...
const std::vector<std::string> DateTime::WEEKDAYS{ "sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday" };
...
{
	std::time_t newSeconds = seconds +(int)n * (int)SECPERDAY;
