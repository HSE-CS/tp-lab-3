...
DateTime::DateTime(unsigned day, unsigned month, unsigned year) {
	...
	strftime(buf, 30, format_stroka, date_time);
	std::string str(buf);
...
DateTime::DateTime() {
	...
	strftime(buf, 30, format_stroka, tm_local);
	std::string str(buf);
	for (size_t i = 0; i < str.size(); ++i) {
		if (str[i] >= 'A' && str[i] <= 'Z') {
			str[i] = tolower(str[i]);
...
unsigned DateTime:: getDifference(DateTime& new_date) {
	int difference_between_dates = 0;
	...
	if (this->year < new_date.year) {
		...
		if ((this->month == 1) || (this->month == 3) || (this->month == 5) || (this->month == 7) || (this->month == 8) || (this->month == 10) || (this->month == 12)) {
			difference_between_dates += 31 - this->day;
		}
		else if (this->month == 2) {
			if ((this->year % 4 == 0 && this->year % 100 != 0) || (this->year % 4 == 0 && this->year % 400 == 0)) {
				difference_between_dates += 29 - this->day;
			}
			else {
				difference_between_dates += 28 - this->day;
			}
		}
		else if ((this->month == 4) || (this->month == 6) || (this->month == 9) || (this->month == 11)) {
			difference_between_dates += 30 - this->day;
		}

		//================================================================

		difference_between_dates += new_date.day;
		...
		while (counter_year != new_date.year) {
			if ((counter_year % 4 == 0 && counter_year % 100 != 0) || (counter_year % 4 == 0 && counter_year % 400 == 0)) {
				difference_between_dates += 366;
			}
			else {
				difference_between_dates += 365;
			}
			counter_year++;
		}
		...
		if ((new_date.month == 1) || (new_date.month == 3) || (new_date.month == 5) || (new_date.month == 7) || (new_date.month == 8) || (new_date.month == 10) || (new_date.month == 12)) {
			difference_between_dates += 31 - new_date.day;
		}
		else if (new_date.month == 2) {
			if ((new_date.year % 4 == 0 && new_date.year % 100 != 0) || (new_date.year % 4 == 0 && new_date.year % 400 == 0)) {
				difference_between_dates += 29 - new_date.day;
			}
			else {
				difference_between_dates += 28 - new_date.day;
			}
		}
		else if ((new_date.month == 4) || (new_date.month == 6) || (new_date.month == 9) || (new_date.month == 11)) {
			difference_between_dates += 30 - new_date.day;
		}
		//===========================================================
		difference_between_dates += this->day;
		...
		if (this->month < new_date.month) {
			...
			difference_between_dates = abs((int)this->day - (int)new_date.day);
		}
	}
